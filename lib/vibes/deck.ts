import { ARCHETYPES, ArchetypeDefinition } from "@/lib/archetypes";
...
export class DeckEngine {
   ...
   */
  public getNextCard(profile: VibeProfile): ArchetypeDefinition | null {
    // 1. Filter out used cards
    const candidates = ARCHETYPES.filter((a) => !this.usedIds.has(a.id));
