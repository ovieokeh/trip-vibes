  ...
  return (
    <Screen scrollable safeArea={false} padded contentContainerClassName="py-6 pb-10">
      ...
      <View className="mb-6">
        ...
        <Text className="text-[16px] leading-6 text-foreground">
          The materials on TripVibes' website are provided on an 'as is' basis. TripVibes makes no warranties, expressed
      ...
      <View className="mb-6">
        ...
        <Text className="text-[16px] leading-6 text-foreground">
          In no event shall TripVibes or its suppliers be liable for any damages (including, without limitation, damages
          for loss of data or profit, or due to business interruption) arising out of the use or inability to use the
          materials on TripVibes' website.
        </Text>
      </View>
    </Screen>
  );
